...
public class Passport implements Identifiable<Integer>, Serializable {
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    // Owner side of one-to-one relation: Passport.holderId ==> User_.id
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    @JoinColumn(name = "holder_id", nullable = false, unique = true)
    @OneToOne
    public User_ getHolder() {
        return holder;
    }

    public void setHolder(User_ holder) {
        this.holder = holder;
    }

    public Passport holder(User_ holder) {
        setHolder(holder);
        return this;
    }
