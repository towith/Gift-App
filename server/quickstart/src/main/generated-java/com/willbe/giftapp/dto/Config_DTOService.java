...
import com.willbe.giftapp.domain.Config__;
...
public class Config_DTOService {
    ...
    public PageResponse<Config_DTO> findAll(PageRequestByExample<Config_DTO> req) {
        ...
        if (config_ != null) {
            ExampleMatcher matcher = ExampleMatcher.matching() //
                    .withMatcher(Config__.ruleValue.getName(), match -> match.ignoreCase().startsWith());
    ...
    public Config_DTO save(Config_DTO dto) {
        ...
        config_.setRuleValue(dto.ruleValue);
    ...
    public Config_DTO toDTO(Config_ config_, int depth) {
        ...
        dto.ruleValue = config_.getRuleValue();
        if (depth-- > 0) {
