...
export class AppComponent implements OnInit {
        ...
        this.items = [
...

            {
                label: 'Entities', icon: 'fa-search', items: [
                    ...
                    {label: 'User_ Search', routerLink: ['/user_-list']},
                    {label: 'User_ Create', routerLink: ['/user_/new']},
                    {label: 'Bench', routerLink: ['/bench/____']},
                ]
            },
            {label: 'Swagger', url: "/swagger-ui.html", icon: 'fa-gear'},
            {
                ...
                items: [
                    ...
                    {
                        label: "Celerio Documentation",
                        icon: 'fa-external-link',
                        url: "http://www.jaxio.com/documentation/celerio/"
                    },
    ...
    login() {
        this.authService.login(this.j_username, this.j_password).subscribe(
            loginOk => {
                if (loginOk) {
